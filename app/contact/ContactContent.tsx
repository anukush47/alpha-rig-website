    ...
    <div className="flex flex-col gap-2">
      <label
        ...
        style={{
          ...
          fontSize: "10px",
          letterSpacing: "2px",
          color: error ? "#E74C3C" : "#555555",
          textTransform: "uppercase",
        }}
      >
        {label}
        {error && <span style={{ color: "#E74C3C", marginLeft: "8px" }}>— {error}</span>}
      </label>
      {children}
    </div>
  );
...
function applyFocus(el: HTMLElement) {
  el.style.borderColor = "rgba(192,57,43,0.6)";
  el.style.boxShadow = "0 0 0 3px rgba(192,57,43,0.08)";
}
  ...
  if (href) {
    return (
      <a
        ...
        onMouseEnter={(e) =>
          ((e.currentTarget.querySelector("p:last-child") as HTMLElement).style.opacity = "0.7")
        }
        onMouseLeave={(e) =>
          ((e.currentTarget.querySelector("p:last-child") as HTMLElement).style.opacity = "1")
        }
      >
        {content}
      </a>
...
export default function ContactContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validate()) return;
    setStatus("loading");
    // UI-only — log payload, wire to API route later
      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full px-6 pb-10" style={{ maxWidth: "1200px" }}>
          ...
          <motion.h1
            ...
            style={{ fontFamily: "var(--font-display)", fontSize: "clamp(48px, 8vw, 72px)", color: "#ffffff", letterSpacing: "0.02em" }}
          >
            CONTACT US
          </motion.h1>
          <motion.p
            ...
            style={{ fontFamily: "var(--font-body)", fontSize: "17px", color: "#888", marginTop: "12px" }}
          >
        ...
        >
              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <p style={{
                    ...
                    Expect a reply within 24 hours. If it&apos;s urgent, reach us directly at{" "}
                    <a href="mailto:hello@alpharig.in" style={{ color: "#C0392B" }}>
                      hello@alpharig.in
                    </a>
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <GlassInput label="Full Name *" id="name" error={errors.name}>
                      <input
                        id="name"
                        type="text"
                        value={form.name}
                    ...
                    <GlassInput label="Email *" id="email" error={errors.email}>
                      <input
                        id="email"
                        type="email"
                        value={form.email}
                  ...
                  {/* Phone + Subject row */}
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <GlassInput label="Phone (optional)" id="phone">
                      <input
                        id="phone"
                        type="tel"
                        value={form.phone}
                    ...
                    <GlassInput label="Subject *" id="subject" error={errors.subject}>
                      <select
                        id="subject"
                        value={form.subject}
                        ...
                        style={{
                          ...
                          appearance: "none",
                          cursor: "pointer",
                          color: form.subject ? "#ffffff" : "#555555",
                        }}
                        onFocus={(e) => applyFocus(e.currentTarget)}
                  ...
                  {/* Message */}
                  <GlassInput label="Message * (min 20 chars)" id="message" error={errors.message}>
                    <textarea
                      id="message"
                      rows={6}
                      value={form.message}
                    ...
                    {form.message.length > 0 && (
                      <span style={{
                        ...
                        fontSize: "9px",
                        letterSpacing: "1px",
                        color: form.message.length < 20 ? "#E74C3C" : "#444",
                        alignSelf: "flex-end",
                        marginTop: "4px",
                      }}>
          ...
          >
            ...
            <div
              ...
              {...infoHandlers}
              className="relative overflow-hidden flex flex-col gap-6 p-6"
              style={{
                backdropFilter: "blur(15px)",
                WebkitBackdropFilter: "blur(15px)",
                background: "rgba(17,17,17,0.7)",
            ...
            >
              <div
                ...
                style={{
                  opacity: 0,
                  background: "radial-gradient(280px circle at var(--x,50%) var(--y,50%), rgba(192,57,43,0.07), transparent 70%)",
                }}
              />
              ...
              <div className="relative z-10 flex flex-col gap-5">
                ...
                <InfoRow
                  label="Location"
                  value="Durg, Chhattisgarh, India — 491001"
                  icon={
                ...
                <div className="flex flex-col gap-3 pt-2" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                  <p style={{ fontFamily: "var(--font-mono)", fontSize: "9px", letterSpacing: "3px", color: "#444" }}>
                    SOCIAL
                  </p>
